...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Fabler/ChameleonFramework.framework"
  ...
  install_framework "Pods-Fabler/Hue.framework"
  ...
  install_framework "Pods-Fabler/RxCocoa.framework"
  install_framework "Pods-Fabler/RxSwift.framework"
  install_framework "Pods-Fabler/SCLAlertView.framework"
  install_framework "Pods-Fabler/SWRevealViewController.framework"
  install_framework "Pods-Fabler/SlackTextViewController.framework"
  install_framework "Pods-Fabler/SwiftDate.framework"
